...
% Fit: 'polynomial6'.
[xData, yData] = prepareCurveData( (man_XX_squ*0.8)+0.1, (man_YY_squ*relacion_xy_squ)+0.05);
...
[xValidation, yValidation] = prepareCurveData(XX, YYx);
...
% Fit: 'polynomial6'.
[xData, yData] = prepareCurveData( (man_XX_tap*0.8)+0.1, (man_YY_tap*relacion_xy_tap)+0.05 );
...
% Fit: 'polynomial6'.
[xData, yData] = prepareCurveData( (man_XX_ova*0.8)+0.1, (man_YY_ova*relacion_xy_ova)+0.05);
...
saveas(figure(3),'man_XX_ova.png');
...
ssetotal= sse_ova + sse_tap + sse_squ
rmse_total = rmse_ova + rmse_tap + rmse_squ

see_ova_por = (ssetotal-sse_ova)/ssetotal 

see_tap_por = (ssetotal-sse_tap)/ssetotal 

see_squ_por = (ssetotal-sse_squ)/ssetotal 

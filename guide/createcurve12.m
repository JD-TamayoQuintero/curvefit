function [fitresult, gof] = createcurve12(man_XX_ovo, man_YY_ovo, man_XX_tap, man_YY_tap, man_XX_squ, man_YY_squ)
...
%  Auto-generated by MATLAB on 04-Dec-2020 19:54:30
...
legend( h, 'poly6_man_ovo - residuals', 'Zero Line', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( 'man_XX_ovo', 'Interpreter', 'none' );
ylabel( 'man_YY_ovo', 'Interpreter', 'none' );
grid on
...
legend( h, 'poly4_man_ovo - residuals', 'Zero Line', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( 'man_XX_ovo', 'Interpreter', 'none' );
ylabel( 'man_YY_ovo', 'Interpreter', 'none' );
grid on
...
legend( h, 'Fourier4_man_ovo - residuals', 'Zero Line', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( 'man_XX_ovo', 'Interpreter', 'none' );
ylabel( 'man_YY_ovo', 'Interpreter', 'none' );
grid on
...
legend( h, 'Fourier2_man_ovo - residuals', 'Zero Line', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( 'man_XX_ovo', 'Interpreter', 'none' );
ylabel( 'man_YY_ovo', 'Interpreter', 'none' );
grid on
...
legend( h, 'poly6_man_tap - residuals', 'Zero Line', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( 'man_XX_tap', 'Interpreter', 'none' );
ylabel( 'man_YY_tap', 'Interpreter', 'none' );
grid on
...
legend( h, 'poly4_man_tap - residuals', 'Zero Line', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( 'man_XX_tap', 'Interpreter', 'none' );
ylabel( 'man_YY_tap', 'Interpreter', 'none' );
grid on
...
legend( h, 'Fourier4_man_tap - residuals', 'Zero Line', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( 'man_XX_tap', 'Interpreter', 'none' );
ylabel( 'man_YY_tap', 'Interpreter', 'none' );
grid on
...
legend( h, 'Fourier2_man_tap - residuals', 'Zero Line', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( 'man_XX_tap', 'Interpreter', 'none' );
ylabel( 'man_YY_tap', 'Interpreter', 'none' );
grid on
...
legend( h, 'poly6_man_squ - residuals', 'Zero Line', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( 'man_XX_squ', 'Interpreter', 'none' );
ylabel( 'man_YY_squ', 'Interpreter', 'none' );
grid on
...
% Plot residuals.
subplot( 2, 1, 2 );
h = plot( fitresult{10}, xData, yData, 'residuals' );
legend( h, 'poly4_man_squ - residuals', 'Zero Line', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( 'man_XX_squ', 'Interpreter', 'none' );
ylabel( 'man_YY_squ', 'Interpreter', 'none' );
grid on
...
% Plot residuals.
subplot( 2, 1, 2 );
h = plot( fitresult{11}, xData, yData, 'residuals' );
legend( h, 'Fourier4_man_squ - residuals', 'Zero Line', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( 'man_XX_squ', 'Interpreter', 'none' );
ylabel( 'man_YY_squ', 'Interpreter', 'none' );
grid on
...
% Plot residuals.
subplot( 2, 1, 2 );
h = plot( fitresult{12}, xData, yData, 'residuals' );
legend( h, 'Fourier2_man_squ - residuals', 'Zero Line', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label axes
xlabel( 'man_XX_squ', 'Interpreter', 'none' );
ylabel( 'man_YY_squ', 'Interpreter', 'none' );
grid on

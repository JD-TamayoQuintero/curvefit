 ...
 * Return Type  : void
 */
void MEDT_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray *plhs[1])
{
  ...
  emxInit_boolean_T(&st, &image, 2, true);
...
/*
 * File trailer for _coder_MEDT_api.c
 *
 * [EOF]
 */

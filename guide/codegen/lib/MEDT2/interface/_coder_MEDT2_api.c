 ...
 * Return Type  : void
 */
void MEDT2_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray *plhs
               [1])
{
  ...
  emxInit_real_T(&st, &image, 2, true);
  emxInit_real_T(&st, &newimage, 2, true);
...
/*
 * File trailer for _coder_MEDT2_api.c
 *
 * [EOF]
 */
